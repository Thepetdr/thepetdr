          ...
          <div className="hidden md:block animate-fade-in">
            <div className="relative h-[480px] rounded-3xl overflow-hidden shadow-2xl shadow-[#003087]/10-100">
              ...
              <div className="absolute bottom-6 left-6 glass rounded-2xl px-5 py-3 border border-white/60 shadow-lg">
                ...
                <p className="text-lg font-bold text-[#003087]">Premium Products</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl font-bold text-gray-900 tracking-tight">
              A Glimpse{" "}
              <span style={{ background: "linear-gradient(135deg, #003087, #002470)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>Inside</span>
            </h2>
          </div>
