          ...
          <div className="hidden md:block animate-fade-in">
            <div className="relative h-[480px] rounded-3xl overflow-hidden shadow-2xl shadow-[#E07A9A]/10-100">
              ...
              <div className="absolute bottom-6 left-6 glass rounded-2xl px-5 py-3 border border-white/60 shadow-lg">
                ...
                <p className="text-lg font-bold text-[#E07A9A]">Premium Products</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl font-bold text-gray-900 tracking-tight">
              A Glimpse{" "}
              <span style={{ background: "linear-gradient(135deg, #E07A9A, #E07A9A)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>Inside</span>
            </h2>
          </div>
