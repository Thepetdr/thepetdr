          ...
          <div className="hidden md:block animate-fade-in">
            <div className="relative h-[480px] rounded-3xl overflow-hidden shadow-2xl shadow-[#E07A9A]/10-100">
              ...
              <div className="absolute bottom-6 left-6 glass rounded-2xl px-5 py-3 border border-white/60 shadow-lg">
                ...
                <p className="text-lg font-bold text-[#E07A9A]">15+ Expert Vets</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((f, i) => (
              <div
                key={f.title}
                className="bg-white rounded-2xl p-7 border border-[#EFBCB0]-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
              >
          ...
          <div className="space-y-4">
            {faqs.map((faq, i) => (
              <div key={i} className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm hover:shadow-md transition-all duration-300">
                ...
                >
                  <span className="font-medium text-gray-900 text-sm pr-4 group-hover:text-[#E07A9A] transition-colors">
                    {faq.question}
                  </span>
                  <span
