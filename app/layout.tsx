  ...
  return (
    <html lang="en" className="scroll-smooth">
      ...
      >
        ...
        <a
          href="https://wa.me/971065573080"
          target="_blank"
          rel="noreferrer"
          className="fixed bottom-24 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl"
