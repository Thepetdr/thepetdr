        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-2.5 mb-4 group">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#E07A9A] to-[#E07A9A] flex items-center justify-center shadow-md">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-9 h-9 rounded-xl bg-gray-800 hover:bg-gradient-to-br hover:from-[#E07A9A] hover:to-[#E07A9A] flex items-center justify-center text-gray-400 hover:text-white transition-all duration-300"
              >
            ...
            <ul className="space-y-3">
              {serviceLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-gray-500 hover:text-[#E07A9A] transition-colors duration-200 flex items-center gap-2 group"
                  >
                    <span className="w-1.5 h-1.5 rounded-full bg-gray-700 group-hover:bg-[#E07A9A] transition-colors duration-200 flex-shrink-0" />
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex items-center gap-3 text-sm text-gray-500 hover:text-[#E07A9A] transition-colors duration-200 group"
              >
